/* ============================================================
   AETHER — WebGL Grainient Fluid Background Engine
   Vanilla JS Port of the OGL Grainient Shader
   ============================================================ */
...
export function initGrainient(container, props = {}) {
  ...
  const program = new Program(gl, {
    ...
    uniforms: {
      ...
      uGrainAnimated:  { value: options.grainAnimated ? 1.0 : 0.0 },
  ...
  return {
    ...
    updateProps: (newProps) => {
      ...
      u.uGrainAmount.value    = merged.grainAmount;
      u.uGrainScale.value     = merged.grainScale;
      u.uGrainAnimated.value  = merged.grainAnimated ? 1.0 : 0.0;
